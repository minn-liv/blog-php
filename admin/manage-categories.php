...
<section class="dashboard">
    <!--  Show if add categories was successful -->
    <?php if (isset($_SESSION['add-category-success'])) : ?>
        ...
        <!--  Show if add categories was NOT successful -->
    ...
    <!--  Show if edit categories was successful -->
    ...
    <!--  Show if edit categories was NOT successful -->
