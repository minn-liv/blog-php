...
if (isset($_POST['submit'])) {
    ...
    if (!$title) {
        $_SESSION['edit-post'] = "1Couldn't update post. Invalid form data on edit post page.";
    } elseif (!$category_id) {
        $_SESSION['edit-post'] = "2Couldn't update post. Invalid form data on edit post page.";
    } elseif (!$body) {
        $_SESSION['edit-post'] = "3Couldn't update post. Invalid form data on edit post page.";
    } else {
